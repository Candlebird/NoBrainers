...
MATERIALS = {
    ...
    "stock_sign":     ((0.20, 0.85, 0.30), 0.5, 0.0, 3.0),   # BP_ShelfActor "stockable" header/floor marker
    ...
    "gunmetal":       ((0.12, 0.12, 0.13), 0.45, 0.8, 0.0),
    "wood_stock":     ((0.40, 0.22, 0.10), 0.6, 0.0, 0.0),
    "blade_steel":    ((0.70, 0.72, 0.74), 0.3, 0.9, 0.0),
    "gold":           ((0.85, 0.65, 0.15), 0.3, 1.0, 0.0),
    "product_green":  ((0.12, 0.40, 0.15), 0.6, 0.0, 0.0),
